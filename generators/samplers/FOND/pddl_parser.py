import os
from samplers.FOND.objs import Variable, Operator
from samplers.FOND.myTask import MyTask
...
class Parser:
  ...
  def generate_file(self, sas_file_name):
    ...
    time_limit = 1000
    command = 'python samplers/FOND/translate/translate.py ' + str(time_limit) + ' ' + self.domain + ' ' + self.problem + ' ' + sas_file_name + ' | grep "noprint"'
