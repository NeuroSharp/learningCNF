...
#ifndef SharpSAT_INSTANCE_H_
#define SharpSAT_INSTANCE_H_
...
protected:
    ...
    LiteralID lookupDiamacsLitID(LiteralID lit) {
        return LiteralID(r_var_map_[lit.var()], lit.sign());
    }
    ...
    std::vector<int>         level_zero_vars;

    std::vector<unsigned> r_var_map_;

    std::vector<Variable> variables_;
    LiteralIndexedVector<TriValue> literal_values_; // The current value of a literal (True, False, Undef)
