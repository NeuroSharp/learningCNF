...
#ifndef SharpSAT_COMPONENT_MANAGEMENT_H_
#define SharpSAT_COMPONENT_MANAGEMENT_H_
...
// This method performs a reachability analysis over the variables
// of a component in order to find subcomponents of it.
// This is done by calling the exploreRemainingCompOf which in turn
// marks the reachable variables from vt as "seen".  Eventually when all eachable
// vars (and clauses) are marked, the makeComponentFromArcheType() makes the component
// over all the "seen" clauses.
