...
#ifndef SharpSAT_SOLVER_H_
#define SharpSAT_SOLVER_H_


#include "statistics.h"
#include "instance.h"
#include "component_management.h"
#include "branching_oracle.h"
...
public:
    ...
    void setBranchingOracle(BranchingOracle *oracle) {
    ...
    void interrupt() { // Trigger an interrupt to the solver.
    ...
    std::vector<int> getLitStack();
    std::vector<int> getBranchingSequence();
    std::vector<int> getLevelZeroVars();
...
private:
    ...
    std::vector<int> branching_sequence; // Just for testing
    ...
    void decideLiteral();
    LiteralID branch(Component &comp);
    bool bcp();
