...
#ifndef SharpSAT_COMPONENT_CACHE_H_
#define SharpSAT_COMPONENT_CACHE_H_
...
public:
    ...
    ComponentCache(SolverConfiguration &config, DataAndStatistics &statistics);
...
private:
    ...
    void reHashTable(unsigned size) {
        ...
        std::cout << "coll " << collisions << std::endl;
    }
